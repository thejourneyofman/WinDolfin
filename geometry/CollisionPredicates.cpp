                                                       ...
                                                       const Point& q1)
{
  ...
  if (((orient2d(q0, q1, p0) > 0.0) ^ (orient2d(q0, q1, p1) > 0.0)) &&
      ((orient2d(p0, p1, q0) > 0.0) ^ (orient2d(p0, p1, q1) > 0.0)))
    return true;
  else
    return false;
}
                                                       ...
                                                       const Point& q1)
{
  ...
  if (collides_segment_point_3d(p0, p1, q0) ||
      ...
      collides_segment_point_3d(q0, q1, p0) ||
  ...
  {
    if (p0[d] == p1[d] && p0[d] == q0[d] && p0[d] == q1[d])
    {
                                                      ...
                                                      const Point& point)
{
  ...
  if (ref > 0.0)
  {
    return (orient2d(p1, p2, point) >= 0.0 &&
	    orient2d(p2, p0, point) >= 0.0 &&
                                                         ...
                                                         const Point& q2)
{
  ...
  {
    if ((s0 &&
    	 orient2d(tri_0[0], tri_0[1], tri_1[i]) <= 0.0 &&
    	 orient2d(tri_0[1], tri_0[2], tri_1[i]) <= 0.0 &&
    ...
    if ((s1 &&
    	 orient2d(tri_1[0], tri_1[1], tri_0[i]) <= 0.0 &&
    	 orient2d(tri_1[1], tri_1[2], tri_0[i]) <= 0.0 &&
                                                         ...
                                                         const Point& point)
{
  ...
  if (ref > 0.0)
  {
    return (orient3d(p0, p1, p2, point) >= 0.0 &&
	    orient3d(p0, p3, p1, point) >= 0.0 &&
	    orient3d(p0, p2, p3, point) >= 0.0 &&
