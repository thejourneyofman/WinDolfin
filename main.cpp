...
#include <dolfin.h>
#include "examples/neumann-poisson/TentativeVelocity.h"
#include "examples/neumann-poisson/PressureUpdate.h"
#include "examples/neumann-poisson/VelocityUpdate.h"
...
int main()
{
    ...
    // Load mesh from file
    auto mesh = std::make_shared<Mesh>("D://VC++//WinDolfin//examples//navier-stokes//lshape.xml.gz");
