...
class poisson1d_coordinate_mapping_1: public ufc::coordinate_mapping
{
public:

  poisson1d_coordinate_mapping_1() : ufc::coordinate_mapping()
  {
    // Do nothing
  }

  ~poisson1d_coordinate_mapping_1() override
  {
    // Do nothing
  }
  ...
  {
    return new poisson1d_coordinate_mapping_1();
  }
  ...
  {
    poisson1d_finite_element_0 xelement;
    double phi[2];
    for (std::size_t ip = 0; ip < num_points; ++ip)
    {
...
public:
  ...
  const char * signature() const final override
  {
    return "9370329b5ced11de6f2756952a6665a0481d3018f2b3c93390ca213c952c357e6773c3d79c3add21d85f3d179eaa17c7412fd40440da5b6be2a70d5ed94b01ad";
  }
